  ...
  return (
    <div className="relative">
      ...
      <div className="bg-[#0A2125] text-white px-8 -mt-28 pb-16 md:pb-24 lg:pb-32 flex flex-col items-center">
        <div className="flex justify-between items-center w-full max-w-[1600px] gap-0 z-[999]">
            ...
            <div className="text-left">
              <div className="flex items-center space-x-4 mb-4">
                <div className="flex items-center justify-center gap-2 bg-[#112A2F] border border-gray-500 p-4 rounded-lg mb-4">
                  <img src={icon1} alt="icon1" className="w-[76px]" />
                  <span className="border-l border-gray-400 h-5 mx-2"></span>
                  <h3 className="font-barlow text-gold_primary text-[14px]">
                    {nadpisStranky}
                  </h3>
                </div>
              </div>
              <p className="text-gray-300 mb-40 mr-20 text-[18px]">
                {prvyText}
              </p>
            </div>
            ...
            <div className="text-left">
              <div className="flex flex-col space-x-4 mb-4">
                ...
                <div className="flex flex-row gap-3">
                  ...
                  <h3 className="text-gold_primary mb-28 uppercase font-bold text-[16px]">
                    Scroll to explore
                  </h3>
                </div>
                <div className="flex items-center space-x-4 mb-4">
                ...
                <div className="text-left max-w-max mb-16">
                  <h2 className="text-[18px] font-light text-gray-300 font-barlow">
                    {predNadpis}{" "}
                    <span className="ml-6 text-4xl md:text-[64px] font-extrabold uppercase max-w-lg leading-[64px] tracking-tight break-words font-barlow bg-gradient-to-r from-gold_secondary to-gold_primary text-transparent bg-clip-text scale-x-90">
                      {zltyNadpis}
                    </span>
                  </h2>
