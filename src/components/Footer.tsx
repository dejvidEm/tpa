    ...
    >
      <div className="flex flex-col md:flex-row justify-between items-center">
        <div className="hidden md:flex flex-row items-center mb-4 md:mb-0">
          <img src="/images/Logo_png.png" alt="" className="w-12" />
  ...
  {isDropdownOpen && (
    <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 bg-[#0A2125] shadow-md rounded-md border border-gray-200 border-opacity-20 z-10 flex flex-row">
      ...
      <div className="flex justify-center my-24 md:my-16 pb-28">
        <div className="hidden md:flex flex-row items-center mb-4 md:mb-0 p-4 rounded-lg border-2 border-white border-opacity-10">
          <img src="/images/fifa_logo.png" alt="" className="w-12" />
          <span className="bg-gray-500 opacity-30 h-[40%] w-0.5 ml-2 mr-4"></span>
          <p className="text-sm text-gold_primary">Certified agents</p>
        </div>
