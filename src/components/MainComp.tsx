            ...
            <div className="flex flex-col space-x-4 mb-4">
              ...
              <div className="text-left max-w-max mb-16">
                <h2 className="font-light text-gray-300 font-barlow text-[18px]">
                  {predNadpis}{" "}
                  <span className="text-gold_primary ml-6 text-4xl md:text-[54px] font-extrabold uppercase leading-[50px] bg-gradient-to-r from-gold_secondary to-gold_primary text-transparent bg-clip-text">
                    {zltyNadpis}
                  </span>
                </h2>
