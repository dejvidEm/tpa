          ...
          <div className="text-left">
            <div className="flex items-center space-x-4 mb-4">
              <div className="flex items-center justify-center gap-2 bg-[#112A2F] border border-gray-500 p-4 rounded-lg mb-4">
                ...
                <h3 className="text-gold_primary text-[14px] font-barlow">{nadpisStranky}</h3>
              </div>
            </div>
          ...
          <div className="text-left">
            <div className="flex flex-col space-x-4 mb-4">
              ...
              <h2 className="font-light text-gray-300 font-barlow text-[18px]">
                  {predNadpis}{" "}
                  <span className="text-gold_primary max-w-92 ml-6 text-4xl md:text-[64px] font-extrabold uppercase leading-tight">
                    {zltyNadpis}
                  </span>
                </h2>
                <div className="flex flex-col gap-6">
                <p className=" text-gray-300 mt-4 text-[18px]">
                  {pravText}
                </p>
                <Link to="/contact">
