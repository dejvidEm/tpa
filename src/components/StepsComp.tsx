    ...
    <div className="bg-[#0A2125] text-white px-8 py-16 md:py-24 lg:py-32 relative">
      <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row md:space-x-12">
        ...
        <div className="flex-1 mb-12">
          <h1 className="justify-start max-w-[500px] text-5xl font-bold mb-12 bg-gradient-to-r uppercase from-gold_secondary to-gold_primary inline-block text-transparent bg-clip-text">
