...
const MobileTransfer: React.FC = () => {
  ...
  return (
    <div className="bg-[#0A2125] text-white px-6 py-8 relative">
      <h1 className='text-3xl md:text-6xl font-extrabold bg-gradient-to-r from-gold_secondary to-gold_primary inline-block text-transparent bg-clip-text mb-10 uppercase leading-8'>
        From Players <br />
