...
const Card: React.FC<Props> = ({ 
  ...
  return (
    <div className="w-64 md:w-80 h-80 md:h-[440px] bg-gray-300 flex flex-col justify-between p-4 rounded">
      ...
      <div className="flex flex-col gap-3 md:gap-4 items-start">
        <h1 className="text-xl md:text-3xl font-bold text-white uppercase leading-none">{title}</h1>
